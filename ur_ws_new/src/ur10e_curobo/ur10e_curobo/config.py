...
@dataclass
class JointsPreset:
    home: List[float] = field(default_factory=lambda: [-1.5053446928607386, -1.6020904980101527, 2.2053263823138636, -4.459911724130148, 4.5944719314575195, 0.03221730515360832]
