...
@dataclass
class JointsPreset:
    home: List[float] = field(default_factory=lambda: [-1.4997957388507288, -1.5250585836223145, 2.258034054433004, -4.589322467843527, 4.572384357452393, 0.048272740095853806]
