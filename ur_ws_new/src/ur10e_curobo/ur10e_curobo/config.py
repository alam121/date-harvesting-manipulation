...
@dataclass
class JointsPreset:
    home: List[float] = field(default_factory=lambda: [-1.4999516646014612, -1.578226228753561, 2.2215502897845667, -4.4997011623778285, 4.572567939758301, 0.048914700746536255]
