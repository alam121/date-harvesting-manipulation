...
class JointsPreset:
    ...
    home: List[float] = field(default_factory=lambda: [-1.4347437063800257, -1.6989251575865687, 2.577709738408224, -4.742356439630026, 4.523527145385742, 0.0047607421875]
