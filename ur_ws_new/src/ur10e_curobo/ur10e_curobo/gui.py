...
class MainWindow(QtWidgets.QWidget):
    ...
    def _build_control_panel(self):
        ...
        # Speed control
        speed_group = QtWidgets.QGroupBox("Speed Control")
        ...
        self.speed_dropoff.setRange(1.0, 6.0)
        self.speed_dropoff.setValue(4.0)
        ...
        self.speed_approach.setRange(0.2, 1.0)
        self.speed_approach.setValue(0.45)
        self.speed_approach.setSingleStep(0.05)
